...
*   `llm_model`: Specifies the language model to be used for plan generation (e.g., "gpt-4-turbo"). Default: "gemini-2.5-pro-preview-05-06". LazyAider uses `litellm` to interact with LLMs, so for advanced model-specific configurations (e.g., enabling reasoning/tool use, setting temperature), refer to the [LiteLLM documentation on providers](https://docs.litellm.ai/docs/providers).
